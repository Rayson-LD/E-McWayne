    ...
    <div className="dropdown dropdown-end">
      ...
      <div tabIndex="0" className="mt-3 card card-compact dropdown-content w-52 bg-base-100 shadow">
        <div className="card-body">
          <span className="font-bold text-lg">{cartItems.reduce((acc,item)=>acc+item.qty,0)} Items</span>
          <span className="text-info">Subtotal: ${cartItems.reduce((acc,item)=>acc+item.qty*item.price,0).toFixed(2)}</span>
